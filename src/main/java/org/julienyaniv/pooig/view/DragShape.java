...
/**
 * Source : https://stackoverflow.com/questions/22594745/drawing-shape-objects-in-java-draggable-resizable-and-can
 * -rotate?rq=1
 * A Shape that can be dragged
 */
@SuppressWarnings("serial")
public class DragShape extends JPanel {
    private static final int PREF_W = 800;
    private static final int PREF_H = 700;
    private static final Color SHAPE_COLOR = new Color(70, 52, 255);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(DragShape::createAndShowGui);
    }
}
